...
use Star\Strategy\PurchasePerKilogramStrategy;
use Star\Strategy\QuantityForPriceOfOneStrategy;
use Star\Strategy\QuantityForPurchaseOfOneStrategy;
...
class PriceTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testShouldHaveNormalPricing($expectedPrice, PurchaseStrategy $strategy)
    {
    ...
    public function provideData()
    {
        ...
        $scenario5 = new PricePerKilogramStrategy(1);
